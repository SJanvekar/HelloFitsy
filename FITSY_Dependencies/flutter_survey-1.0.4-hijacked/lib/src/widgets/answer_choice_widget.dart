...
import 'package:flutter_survey/src/widgets/Flutter_Survery_Constants.dart';
            ...
            .map((answer) => Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Flexible(
                        fit: FlexFit.loose,
                        child: Text(answer, style: textAnswerBody),
                      )
                    ],
                  ),
                ))
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: const InputDecoration(
          ...
          hintStyle: logInPageBodyText,
          focusedBorder: UnderlineInputBorder(
            borderSide: BorderSide(color: shark40),
          ),
          enabledBorder: UnderlineInputBorder(
            borderSide: BorderSide(color: shark),
          ),
        ),
        onChanged: (value) {
